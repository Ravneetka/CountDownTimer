...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.VideoInfoHolder> {
    ...
    public void onBindViewHolder(final VideoInfoHolder holder, final int position) {
        ...
        holder.youTubeThumbnailView.initialize("AIzaSyCfd2L8hNMMcYx0M-F9WpDAnRCXLJmHPNk", new YouTubeThumbnailView.OnInitializedListener() {
            @Override
    ...
    public class VideoInfoHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent = YouTubeStandalonePlayer.createVideoIntent((Activity) ctx, "AIzaSyCfd2L8hNMMcYx0M-F9WpDAnRCXLJmHPNk",
